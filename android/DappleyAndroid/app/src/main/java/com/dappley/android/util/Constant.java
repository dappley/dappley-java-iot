...
public class Constant {
    ...
    public static final String STEP_CONTRACT_TPL = "{\"function\":\"record\",\"args\":[\"%s\",\"{}\"]}";
    ...
    public static final String URL_CONTRACT_ADDRESS = URL_CONTRACT_BASE + "contract_addr/record3";
