...
public class TransferActivity extends AppCompatActivity {
    ...
    void transfer() {
        ...
        if (!wallet.isBtWallet()) {
            normalWalletTransfer(amount);
        } else {
            bleWalletTransfer(amount);
        }
    }

    private void normalWalletTransfer(BigInteger amount) {
        if (walletPasswordDialog == null) {
            walletPasswordDialog = new WalletPasswordDialog(this, new WalletPasswordDialog.OnClickListener() {
                ...
                public void onConfirm(String password) {
                    onPasswordInput(password, amount);
                }
            });
        }
    ...
    private void bleWalletTransfer(BigInteger amount) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    DeviceService deviceService = new BleDeviceService(wallet, bleWalletService);
                    sendTxResult = Dappley.sendBleDeviceTransaction(wallet.getAddress(), toAddress, amount, tip, deviceService);
                } catch (Exception e) {
    ...
    private void onPasswordInput(String password, BigInteger amount) {
