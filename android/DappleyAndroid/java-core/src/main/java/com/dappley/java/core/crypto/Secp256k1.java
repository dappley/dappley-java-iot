...
public class Secp256k1 {
    ...
    public static byte[] GenerateECKey() {
        ...
        ECKeyGenerationParameters keygenParams = new ECKeyGenerationParameters(CURVE, SecureRandomUtils.secureRandom());
        generator.init(keygenParams);
        AsymmetricCipherKeyPair keypair = generator.generateKeyPair();
        ECPrivateKeyParameters privParams = (ECPrivateKeyParameters) keypair.getPrivate();
        BigInteger privKey = privParams.getD();
        return ByteUtil.bigInteger2Bytes(privKey, 32);
    }
    ...
    public static class ECDSASignature {
        ...
        private static final BigInteger SECP256K1N = new BigInteger("FFFFFFFF00000000FFFFFFFFFFFFFFFFBCE6FAADA7179E84F3B9CAC2FC632551", 16);
        ...
        public String toBase64() {
            ...
            sigData[0] = v;
            System.arraycopy(ByteUtil.bigInteger2Bytes(this.r, 32), 0, sigData, 1, 32);
            System.arraycopy(ByteUtil.bigInteger2Bytes(this.s, 32), 0, sigData, 33, 32);
        ...
        public byte[] toByteArray() {
            ...
            return ByteUtil.joinBytes(
                    ...
                    ByteUtil.bigInteger2BytesOmitSign(this.s),
                    new byte[]{fixedV});
        }
